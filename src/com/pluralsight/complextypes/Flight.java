...
public class Flight implements Comparable<Flight>, Iterable<Person> { //20180807 relationships with interfaces
    ...
    int getSeatsOnPlane() {return 150;}//will be overridden!  (see comment!)
        ...
        private int flightTime; //minutes past midnight (12:15 = 15; 1:30 = 90

        private CrewMember[] crew; //keep track of all the people!
        private Passenger[] roster; // member variable array of Passengers
        ...
        @Override //redefining what tostring is!
            ...
            if(flightNumber != null)//can check to see if anything was in there
                return "Flight Number "+ flightNumber + " -- Flight Time:  " + flightTime;
        ...
        public void setFlightTime(int flightTime){
            this.flightTime = flightTime; //right hand is the parameter, left hand is the field
        }
    ...
    // Constructors
        ...
        public void add1Passenger() {
            if (hasSeating()) {
                passengers += 1;
                allPassengers += 1; // adds to all passenger static variable for all flights
            }
            else
                handleTooMany();
        }

        //in addition to each flight keeping track of passengers on THAT flight,
        //also want an easy way to keep track of passengers on the total of ALL flights
        static int allPassengers; // not associated with any instance
        static int getAllPassengers(){
            return allPassengers;
        }
        static int resetAllPassengers(){
            allPassengers = 0;
            return allPassengers; //this line was not in the tutorial, but pgm ABENDED when it ran w/o it
        }
        ...
        public int compareTo(Flight f) {
            //Flight f = (Flight) o;
//            if(flightTime < f.flightTime) //originally written, the next statement replaces all of this
//                return -1;
//            else
...
//        }
    ...
    //public Iterator<Person> iterator() {
    //    return new FlightIterator(roster);
    //}
